...
class QuestionSeeder extends Seeder
{
    public function run(): void
    {
        $data = [
            'Sport' => [
                ['question' => 'Combien de joueurs dans une équipe de foot ?', 'answers' => [
                    ['answer' => '11', 'is_correct' => true],
                    ['answer' => '9', 'is_correct' => false],
                    ['answer' => '10', 'is_correct' => false],
                    ['answer' => '12', 'is_correct' => false],
                ]],
                ['question' => 'Dans quel sport utilise-t-on un volant ?', 'answers' => [
            ...
            'Culture' => [
                ['question' => 'Qui a peint la Joconde ?', 'answers' => [
                    ...
                    ['answer' => 'Raphaël', 'is_correct' => false],
                ]],
            ],
            'Jeux Vidéo' => [
                ['question' => 'Quel est le plombier de Nintendo ?', 'answers' => [
                    ['answer' => 'Mario', 'is_correct' => true],
                    ['answer' => 'Link', 'is_correct' => false],
                    ['answer' => 'Kirby', 'is_correct' => false],
                    ['answer' => 'Donkey Kong', 'is_correct' => false],
                ]],
            ],
            'Science' => [
                ['question' => 'Quelle est la formule de l\'eau ?', 'answers' => [
